...
class TitleState extends MusicBeatState
{
  ...
  var overlay:Sprite;
  var curVersion:String = Constants.TWEAKED_VERSION;
  ...
  function netConnection_onNetStatus(event:NetStatusEvent):Void
  {
    ...
    // TODO: Make this an option in preferences too!
    trace('checking for update');
    var http = new haxe.Http("https://raw.githubusercontent.com/CharGoldenYT/Funkin-Tweaked/0.7%2B/gitver.txt");
